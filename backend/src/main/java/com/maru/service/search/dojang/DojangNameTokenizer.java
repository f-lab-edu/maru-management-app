...
import com.maru.service.search.rule.segment.PrefixSegmentRule;
import com.maru.service.search.rule.segment.SuffixSegmentRule;
import com.maru.service.search.rule.tokenize.BiGramTokenizeRule;
...
// 도장명 인덱싱용 토크나이저
@Component
public class DojangNameTokenizer implements Tokenizer {

    private final TokenizerEngine engine;

    public DojangNameTokenizer() {
        this.engine = TokenizerEngine.builder()
                ...
                // 접두사(대학명/브랜드), 접미사(태권도장/체육관), 영한 분리
                .segment(
