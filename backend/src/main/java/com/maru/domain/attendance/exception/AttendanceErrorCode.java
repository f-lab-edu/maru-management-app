...
public enum AttendanceErrorCode implements BaseErrorCode {
    ...
    CHECKOUT_BEFORE_CHECKIN(HttpStatus.BAD_REQUEST, "ATTENDANCE_303", "퇴관 시각은 입관 시각보다 이후여야 합니다"),
    SAME_STATUS(HttpStatus.BAD_REQUEST, "ATTENDANCE_304", "이미 동일한 상태입니다"),
    DATE_RANGE_TOO_LARGE(HttpStatus.BAD_REQUEST, "ATTENDANCE_305", "조회 기간은 최대 31일입니다"),
    DATE_RANGE_INVALID(HttpStatus.BAD_REQUEST, "ATTENDANCE_306", "시작일은 종료일보다 이전이어야 합니다"),
    RETROACTIVE_LIMIT_EXCEEDED(HttpStatus.BAD_REQUEST, "ATTENDANCE_307", "소급 입력은 최대 30일까지 가능합니다");
