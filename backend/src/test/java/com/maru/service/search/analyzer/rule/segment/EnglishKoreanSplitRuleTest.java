...
class EnglishKoreanSplitRuleTest {
    ...
    void splitEnglishKorean() {
        AnalyzeContext context = AnalyzeContext.of("MTA태권도");
    ...
    void splitKoreanEnglish() {
        AnalyzeContext context = AnalyzeContext.of("태권도MTA");
    ...
    void splitNumberKorean() {
        AnalyzeContext context = AnalyzeContext.of("성도2관");
    ...
    void splitKoreanNumber() {
        AnalyzeContext context = AnalyzeContext.of("강남1");
    ...
    void splitComplex() {
        AnalyzeContext context = AnalyzeContext.of("MTA2태권도");
